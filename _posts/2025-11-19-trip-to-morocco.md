...
I fancied some ~~winter~~ early spring sun, so back in November 2024 I found a cheap flight to Agadir and booked into [Sundesk](https://sun-desk.com/), a coliving space in Taghazout. Coliving is a relatively new concept which is a cross between a flatshare and a coworking space. The guests are usually digital nomads, freelancers, and remote workers.
...
<figure>
<a href="https://www.strava.com/activities/13797318687">
<img src="{{ "/assets/images/morocco/agadir-ride.png" | relative_url }}"
alt="Bike ride in Agadir region."
class="img-small">
</a>
<figcaption>Click the image to view the activity on Strava.</figcaption>
</figure>
...
<div class="photo-grid">
  <img src="{{ '/assets/images/morocco/DSC00112.JPG' | relative_url }}" alt="Taghazout Skate Park" onclick="openLightbox(this)">
  <img src="{{ '/assets/images/morocco/DSC00126.JPG' | relative_url }}" alt="Sunset over the ocean" onclick="openLightbox(this)">
  <img src="{{ '/assets/images/morocco/DSC00141.JPG' | relative_url }}" alt="Sunset surfers" onclick="openLightbox(this)">
  <img src="{{ '/assets/images/morocco/IMG_2229 2.JPG' | relative_url }}" alt="Me jumping into a natural pool in Paradise Valley" onclick="openLightbox(this)">
  <img src="{{ '/assets/images/morocco/PXL_20250304_183629132.jpg' | relative_url }}" alt="Another sunset in Taghazout" onclick="openLightbox(this)">
  <img src="{{ '/assets/images/morocco/PXL_20250305_140142478.jpg' | relative_url }}" alt="Winding hairpins that I cycled up. Not pictured: All the ones above me I didn't attempt" onclick="openLightbox(this)">
  <img src="{{ '/assets/images/morocco/PXL_20250306_102942282.jpg' | relative_url }}" alt="Great vegan food at Red Clay" onclick="openLightbox(this)">
  <img src="{{ '/assets/images/morocco/PXL_20250308_204823977.jpg' | relative_url }}" alt="Nice wordmarks for Taghazout in Arabic, Roman and Berber" onclick="openLightbox(this)">
</div>
